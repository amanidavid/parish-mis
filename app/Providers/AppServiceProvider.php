...
use App\Policies\DailyExpenseTypePolicy;
use App\Policies\DailyPropertyExpensePolicy;
use App\Policies\MaintenanceExpensePolicy;
use App\Policies\MaintenanceJobPolicy;
use App\Policies\PropertyPolicy;
use App\Policies\PropertyInvoicePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(DailyExpenseType::class, DailyExpenseTypePolicy::class);
        Gate::policy(DailyPropertyExpense::class, DailyPropertyExpensePolicy::class);
