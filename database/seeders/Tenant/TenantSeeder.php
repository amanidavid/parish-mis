...
class TenantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $perms = [
            ...
            'daily_expense_types.view','daily_expense_types.create','daily_expense_types.update','daily_expense_types.delete',
        ...
        foreach ([
            ...
            'daily_expense_types.view', 'daily_expense_types.create', 'daily_expense_types.update',
